      ...
      <div className="container-fluid">
          ...
          <div className="container">
            <div className="row">
              <div className="col-sm-12 col-md-6 landing-text-container">
                <h1 className="landing-header fw-bold">FAQ's for Parents</h1>
        ...
        <div className="container w-50 mb-5">
          ...
          <p className="mb-5">
            ...
            nanny agency, but a marketplace, with the aim of giving all of us as
            parents the ability to view, review and make choices about the
            childcare options available to us. We are not a childcare agency. We
            do not personally meet or vet the caregivers on our platform.
          ...
          <p className="mb-5">
            ...
            one-off, no-commitment option of 3 months full access or a monthly
            subscription option, which can be cancelled at any time. See our
            pricing page for further details. Also included in the annual
            subscription is Garda vetting on request. See our Garda vetting page
            for more details. SureSitter does not set the rates of pay for
          ...
          <p className="mb-5">
            ...
            recommend that you check all employment history, references,
            immigration and visa status so you can be sure that you are making
            the most informed decision possible. We provide parents with the
            tools necessary to enable you to find the right caregiver for you
            and your family. We also carry out ID-verification checks. This
            provides you with an additional layer of trust. If a sitter has been
            ID-verified you will see the following badge on their profile. We do
