  ...
  return (
    <>
      ...
      <div className="container-fluid">
        <div className="container">
          <div className="row">
            <div className="col-sm-12 col-md-6 landing-text-container">
              <h1 className="landing-header header-color">FAQ's for Sitters</h1>
        ...
        <div className="container">
          <h2>FAQs for Nannies, Childminders, Au Pairs and Babysitters</h2>
          <h3>Who can sign up to GoNanny?</h3>
          <p>
          ...
          <p>You must be over 18 to join GoNanny.</p>
